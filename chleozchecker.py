...
def main():
    ...
    if os.path.basename(__file__) != 'chleozchecker.py':
        print("Dosya adı chleozchecker.py olmalıdır.")
        return

    if len(sys.argv) != 3:
        print("Hatalı Kullanım! Doğru Kullanım: python  chleozchecker.py urllist thread")
        return
