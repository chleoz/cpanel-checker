...
def print_banner():
    try:
        banner = pyfiglet.figlet_format("H4XFE ~ SPYHACKERZ", font="big")
...
def main():
    ...
    if os.path.basename(__file__) != 'h4xfechecker.py':
        print("Dosya adı h4xfechecker.py olmalıdır.")
        return

    if len(sys.argv) != 3:
        print("Hatalı Kullanım! Doğru Kullanım: python h4xfechecker.py urllist thread")
        return
